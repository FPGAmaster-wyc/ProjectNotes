...
```shell
.\openocd.exe -f .\ftdi.cfg -c "init" -c "pld load 0 F:\\my_work\\openocd\\bit\\led_system.bit"
```

通过telnet下载PL端程序

```shell
pld load 0 "F:\\my_work\\openocd\\bit\\led_system.bit"
```
